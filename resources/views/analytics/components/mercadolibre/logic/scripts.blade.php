...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const canvas = document.getElementById('salesTrendChartMercadoLibre');
        if (!canvas) return;
        ...
        gradient.addColorStop(0, 'rgba(255, 193, 7, 0.3)'); // Amarillo (warning) para Mercado Libre
        ...
        new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: 'Ingresos Mercado Libre (S/)',
                    data: dataMonto,
                    borderColor: '#ffc107',
