<div class="card border-0 shadow-sm rounded-4 mt-4">
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" id="tablaMercadoLibreSku">
                ...
                <tbody>
                    @forelse($skusMercadoLibre as $sku)
                    <tr>
                        <td class="ps-4">
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5 text-muted">
                            ...
                            No hay productos registrados en Mercado Libre para este período.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
