    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h5 class="fw-bold mb-0">Tendencia de Ventas - Tienda</h5>
                    <small class="text-muted">{{ $filtros['fecha_inicio']->translatedFormat('d M Y') }} &mdash; {{ $filtros['fecha_fin']->translatedFormat('d M Y') }}</small>
                </div>
            </div>
            <div style="height: 380px; width: 100%; position: relative;">
                <canvas id="salesTrendChartTienda"></canvas>
            </div>
        </div>
        <div class="col-lg-3 d-flex flex-column justify-content-center border-start ps-lg-4 mt-4 mt-lg-0">
            ...
            <div class="p-3 bg-light rounded-4 border">
                <h6 class="text-secondary small mb-1 text-uppercase fw-bold">D&iacute;a con mayor ingreso</h6>
                @php
