<div class="card border-0 shadow-sm rounded-4 mt-4">
    <div class="card-header bg-white border-bottom-0 pt-4 pb-3 px-4 d-flex justify-content-between align-items-center">
        <h5 class="fw-bold mb-0 text-dark">
            <i class="bi bi-box-seam me-2 text-warning"></i>Rendimiento por SKU / Producto
        </h5>
    </div>
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" id="tablaTiendaSku">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="text-uppercase small fw-bold text-secondary text-end">Costos</th>
                        <th class="text-uppercase small fw-bold text-secondary text-end pe-4">Rentabilidad</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse($skusTienda as $sku)
                    <tr>
                        <td class="ps-4">
                        ...
                        <td class="text-end">
                            <div class="d-flex flex-column align-items-end justify-content-center">
                                <span class="text-muted" style="font-size: 0.85rem;" title="Costo Total">
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-5 text-muted">
                            ...
                            No hay productos registrados en Tienda para este período.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
