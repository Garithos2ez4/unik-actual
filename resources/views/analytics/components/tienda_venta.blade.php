...
<div class="container pb-5">
    ...
    <div class="mt-5">
        <h4 class="fw-bold text-dark mb-4"><i class="bi bi-bank text-primary me-2"></i>Desglose de Transferencias por Banco / Método de Pago</h4>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-uppercase small fw-bold text-secondary">Fecha</th>
                                    <th class="text-uppercase small fw-bold text-secondary">Vendedor</th>
                                    <th class="text-uppercase small fw-bold text-secondary">Nro. Operación</th>
        ...
        @empty
            <div class="alert alert-light border text-muted mt-3">
                <i class="bi bi-info-circle me-2"></i>No hay transferencias ni pagos detallados en este período.
            </div>
        @endforelse
    </div>
</div>
