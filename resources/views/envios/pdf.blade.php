...
<head>
    ...
    <style>
        * {
        ...
        /* Estilos de Pantalla e Interactividad */
        .controls-bar {
...
<body>
    <div class="no-print controls-bar">
        <div>
            <h4 style="margin: 0 0 5px 0; color: white;">Configuración de Impresión</h4>
            <span style="font-size: 13px; color: #ccc;">Selecciona la cantidad de rótulos por hoja:</span>
        </div>
        <div style="display: flex; align-items: center;">
            ...
            <button onclick="window.print()" class="btn-print" style="margin-left: 20px;">
                🖨️ Imprimir
            </button>
        </div>
    </div>
        ...
        <div id="rotulos-container">
            ...
            <div class="header">
                <div class="remitente">
                    ...
                    <div class="remitente-line">FLOR DE MARIA QUIÑONES ENRIQUEZ</div>
                    <div class="remitente-line">Dir.: AV. RAMON CARCAMO 785 - E203</div>
                    <div style="display: flex; justify-content: space-between; max-width: 400px;">
                        <div class="remitente-line">Ciu.: LIMA - LIMA</div>
                    </div>
                    <div style="display: flex; gap: 30px;">
                        <div class="remitente-line">Cel.: 949064561</div>
                        <div class="remitente-line">DNI/RUC: 10424505787</div>
                    </div>
                </div>
            ...
            <div class="bottom-section">
                ...
                <div class="destinatario">
                    ...
                    <div class="d-line-group">
                        ...
                        <div class="d-value" style="flex: 1;">{{ $envio->Destino->nombre ?? '' }}</div>
                        <div class="d-label" style="margin-left: 10px;">Prov.:</div>
                        <div class="d-value" style="flex: 1;">{{ $envio->Destino->Provincia->nombre ?? '' }}</div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Guardamos las referencias de los rótulos originales al cargar la página
            originalWrappers = Array.from(document.querySelectorAll('.rotulo-wrapper'));
            
            // Selección automática del layout óptimo según la cantidad de rótulos
        ...
        function changeLayout(num) {
            ...
            document.getElementById(`btn-l${num}`).classList.add('active');
        }
    </script>
</body>
</html>
