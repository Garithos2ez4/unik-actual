...
<head>
    ...
    <script src="{{ asset('js/header-scripts.js') }}?v=1.03"></script>
        ...
        <div class="offcanvas offcanvas-start bg-sistema-uno" tabindex="-1" id="offcanvasDashboard"
            ...
            <div class="offcanvas-body ">
                <ul class="list-group list-group-flush ">
                    ...
                    <li class="list-group-item bg-sistema-uno menu-border"><a
                            href="{{ route('documentos', [now()->format('Y-m')]) }}" class="btn text-light">Movimientos <i
                        ...
                        <ul class="list-unstyled ps-3 mt-1">
                            ...
                            <li class="mb-1 mt-2">
                                ...
                                <ul class="collapse list-unstyled ps-3 mt-1" id="collapseRipley">
                                    <li>
                                        <a href="{{ route('dashboard.herramientas.scraper_ripley') }}" class="btn btn-sm text-info py-0">
                                            <i class="bi bi-search me-1"></i> Verificador de Precios
                                        </a>
                                    </li>
                                    <li>
