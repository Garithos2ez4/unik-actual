<div class="table-responsive">
    <table class="table table-custom table-hover m-0">
        <thead>
            <tr>
                <th class="bg-sistema-uno ps-4">Orden Ripley</th>
        ...
        <tbody>
            @forelse($ripleyPendientes as $orden)
            <tr>
                ...
                <td class="text-muted">{{ $orden->created_at_ripley ? $orden->created_at_ripley->format('d/m/Y H:i') : 'N/A' }}</td>
                <td><span class="badge bg-purple bg-opacity-10 border text-white">{{ ucfirst($orden->status) }}</span></td>
            ...
            <tr>
                <td colspan="7" class="text-center text-muted py-5">
                    <i class="bi bi-shop-window fs-2 d-block mb-2 text-light"></i>
                    No hay egresos pendientes de Ripley.
                </td>
            </tr>
            @endforelse
        </tbody>
