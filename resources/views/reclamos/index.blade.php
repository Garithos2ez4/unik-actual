            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-3">
                                <span class="badge bg-light text-dark border">{{ $reclamo->codigoReclamo }}</span>
                            </td>
                            <td>
                            ...
                            <td>{{ $reclamo->fechaReclamo->format('d-m-Y') }}</td>
                            <td>
                                @if($reclamo->Cliente)
                                    <span class="text-truncate d-inline-block" style="max-width: 150px;" title="{{ $reclamo->Cliente->nombre }} {{ $reclamo->Cliente->apellidoPaterno }}">
                                        {{ $reclamo->Cliente->nombre }} {{ $reclamo->Cliente->apellidoPaterno }}
                                    </span>
                                @else
                                    <span class="text-muted">{{ $reclamo->nombresCliente ?? 'N/A' }}</span>
                                @endif
                            </td>
                            <td>
                                <span class="badge bg-info text-dark">{{ $reclamo->Plataforma->nombrePlataforma ?? 'N/A' }}</span>
                            </td>
                            <td>{{ $reclamo->CuentaPlataforma->nombreCuenta ?? 'N/A' }}</td>
                            ...
                            <td>{{ $reclamo->TipoReclamo->nombreTipoReclamo ?? 'N/A' }}</td>
